...
urlpatterns = [
    ...
    path('delete3/<int:pk>/',views.LessonDeleteView.as_view(),name='delete3'),            #削除画面(授業)
    ...
    path('messagedelete/<int:pk>/',views.MessageDeleteView.as_view(),name='delete4'),     #お知らせ削除画面
]